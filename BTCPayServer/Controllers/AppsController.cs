    ...
    public partial class AppsController : Controller
    {
        ...
        public async Task<IActionResult> DeleteAppPost(string appId)
        {
            ...
            if (await _AppService.DeleteApp(appData))
                StatusMessage = "Aplicación eliminada con éxito";
        ...
        public async Task<IActionResult> DeleteApp(string appId)
        {
            ...
            {
                Title = $"Eliminar aplicación {appData.Name} ({appData.AppType})",
                Description = "Esta aplicación será eliminada de esta tienda.",
                Action = "Eliminar"
            });
        }
