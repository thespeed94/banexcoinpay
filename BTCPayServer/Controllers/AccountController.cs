    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> LoginWithU2F(LoginWithU2FViewModel viewModel, string returnUrl = null)
        {
            ...
            try
            {
                ...
                errorMessage = "Intento de inicio de sesión no válido.";
            }
            catch (Exception e)
            {
        ...
        public async Task<IActionResult> LoginWith2fa(LoginWith2faViewModel model, bool rememberMe, string returnUrl = null)
        {
            ...
            else
            {
                ...
                ModelState.AddModelError(string.Empty, "Código de autentificador inválido.");
                return View("SecondaryLogin", new SecondaryLoginViewModel()
                {
        ...
        public async Task<IActionResult> LoginWithRecoveryCode(LoginWithRecoveryCodeViewModel model, string returnUrl = null)
        {
            ...
            {
                _logger.LogWarning("Código de recuperación no válido introducido para el usuario con ID {UserId}", user.Id);
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null, bool logon = true)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    Logs.PayServer.LogInformation($"Un nuevo usuario recién registrado {user.Email} {(admin.Count == 0 ? "(admin)" : "")}");
                    ...
                    {
                        TempData["StatusMessage"] = "Cuenta creada, por favor confirme su email";
                        return View();
                    }
                }
                AddErrors(result);
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            if (remoteError != null)
            {
                ErrorMessage = $"Error de proveedor externo: {remoteError}";
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("Usuario conectado con {Name} proveedor.", info.LoginProvider);
                return RedirectToLocal(returnUrl);
            }
            if (result.IsLockedOut)
            {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                _EmailSenderFactory.GetEmailSender().SendEmail(model.Email, "Restablecer la contraseña",
