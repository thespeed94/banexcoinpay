...
namespace BTCPayServer.Controllers
{
    public partial class InvoiceController : Controller
    {
        ...
        internal async Task<DataWrapper<InvoiceResponse>> CreateInvoiceCore(CreateInvoiceRequest invoice, StoreData store, string serverUrl, List<string> additionalTags = null, CancellationToken cancellationToken = default)
        {
            ...
            logs.Write("Creación de factura a partir.");
            ...
            if (entity?.BuyerInformation?.BuyerEmail != null)
            {
                if (!EmailValidator.IsEmail(entity.BuyerInformation.BuyerEmail))
                    throw new BitpayHttpException(400, "Email inválido");
            ...
            if (supported.Count == 0)
            {
                ...
                errors.AppendLine("Advertencia: no se ha vinculado ninguna billetera a su tienda BTCPay. Vea el siguiente enlace para obtener más información sobre cómo conectar su tienda y su billetera. (https://docs.btcpayserver.org/btcpay-basics/gettingstarted#connecting-btcpay-store-to-your-wallet)");
            ...
            using (logs.Measure("Factura de ahorro"))
            {
            ...
            _ = Task.Run(async () =>
            {
                ...
                {
                    ex.Handle(e => { logs.Write($"Error al obtener las tasas {ex}"); return true; });
                }
