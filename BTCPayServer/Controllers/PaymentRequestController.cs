    ...
    public class PaymentRequestController : Controller
    {
        ...
        public async Task<IActionResult> EditPaymentRequest(string id, UpdatePaymentRequestViewModel viewModel)
        {
            if (string.IsNullOrEmpty(viewModel.Currency) ||
                ...
                ModelState.AddModelError(nameof(viewModel.Currency), "Moneda invalida");
            ...
            return RedirectToAction("EditPaymentRequest", new {id = data.Id, StatusMessage = "Guardado"});
        }
        ...
        public async Task<IActionResult> RemovePaymentRequestPrompt(string id)
        {
            ...
            return View("Confirm", new ConfirmModel()
            {
                ...
                Description = $"¿Está seguro de que desea eliminar el acceso a la solicitud de pago? '{blob.Title}' ?",
                Action = "Delete"
            });
        }
            ...
            decimal? amount = null, CancellationToken cancellationToken = default)
        {
            ...
            if (result.AmountDue <= 0)
            {
                ...
                return BadRequest("La solicitud de pago ya se ha resuelto.");
            }
            ...
            if (result.ExpiryDate.HasValue && DateTime.Now >= result.ExpiryDate)
            {
                ...
                return BadRequest("La solicitud de pago ha caducado");
            }
