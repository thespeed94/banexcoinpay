    ...
    public class AppsPublicController : Controller
    {
        ...
        public async Task<IActionResult> ViewCrowdfund(string appId, string statusMessage)
        {
            ...
            if (!hasEnoughSettingsToLoad)
            {
                ...
                return NotFound("Se debe establecer una moneda de destino para esta aplicación para poder cargarse.");
            }
        ...
        public async Task<IActionResult> ContributeToCrowdfund(string appId, ContributeToCrowdfund request, CancellationToken cancellationToken)
        {
            ...
            {
                return NotFound("Crowdfund no está activo actualmente");
            }
            ...
            if (!string.IsNullOrEmpty(request.ChoiceKey))
            {
                ...
                if (choice == null)
                    return NotFound("Opción incorrecta proporcionada");
                title = choice.Title;
            ...
            {
                return NotFound("El monto de la contribución es más de lo que se permite actualmente.");
            }
