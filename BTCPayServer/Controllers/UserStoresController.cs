...
namespace BTCPayServer.Controllers
{
    ...
    public partial class UserStoresController : Controller
    {
        ...
        public IActionResult DeleteStore(string storeId)
        {
            ...
            {
                Title = "Eliminar tienda " + store.StoreName,
                Description = "Esta tienda seguirá siendo accesible para los usuarios que la compartan.",
                Action = "Eliminar"
            });
        }
        ...
        public async Task<IActionResult> DeleteStorePost(string storeId)
        {
            ...
            StatusMessage = "Tienda eliminada exitosamente";
