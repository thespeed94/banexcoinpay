...
namespace BTCPayServer.Controllers
{
    ...
    public partial class StoresController : Controller
    {
        ...
        public async Task<IActionResult> DeleteStoreUserPost(string storeId, string userId)
        {
            ...
            StatusMessage = "Usuario eliminado exitosamente";
        ...
        public IActionResult ShowRateRules(bool scripting)
        {
            ...
            {
                Action = "Continue",
                Title = "Secuencia de comandos de regla",
                Description = scripting ?
                                "Esta acción modificará sus fuentes de tasa actuales. ¿Está seguro de activar las reglas de tasa de scripting? (Usuarios avanzados)"
                                : "Esta acción borrará su script de tasa. ¿Está seguro de desactivar las reglas de tasa de comandos?",
        ...
        public async Task<IActionResult> ShowRateRulesPost(bool scripting)
        {
            ...
            await _Repo.UpdateStore(StoreData);
            StatusMessage = "Reglas de scripting activadas";
        ...
        public IActionResult DeleteStore(string storeId)
        {
            return View("Confirm", new ConfirmModel()
            {
                ...
                Description = "Esta acción es irreversible y eliminará toda la información relacionada con esta tienda. (Facturas, Apps etc ...)",
        ...
        public async Task<IActionResult> DeleteStorePost(string storeId)
        {
            ...
            StatusMessage = "Exito: la tienda se ha eliminado correctamente";
        ...
        public async Task<IActionResult> RevokeToken(string tokenId)
        {
            ...
            return View("Confirm", new ConfirmModel()
            {
                ...
                Description = $"El token de acceso con la etiqueta. \"{token.Label}\" será revocado, desea continuar?",
                ButtonClass = "btn-danger"
            });
        }
        [HttpPost]
        ...
        public async Task<IActionResult> RevokeTokenConfirm(string tokenId)
        {
            ...
            if (token == null ||
               ...
               !await _TokenRepository.DeleteToken(tokenId))
                StatusMessage = "No revocar este token";
            else
                StatusMessage = "Token revocado";
        ...
        public async Task<IActionResult> GenerateAPIKey()
        {
            ...
            StatusMessage = "Clave API re-generada";
            return RedirectToAction(nameof(ListTokens));
        }
        ...
        public async Task<IActionResult> RequestPairing(string pairingCode, string selectedStore = null)
        {
            ...
            if (pairing == null)
            {
                StatusMessage = "Código de emparejamiento desconocido";
                return RedirectToAction(nameof(UserStoresController.ListStores), "UserStores");
            }
            else
            {
        ...
        public async Task<IActionResult> Pair(string pairingCode, string selectedStore)
        {
            ...
            if (pairingResult == PairingResult.Complete || pairingResult == PairingResult.Partial)
            {
                ...
                StoreNotConfigured = store.GetSupportedPaymentMethods(_NetworkProvider)
                                          ...
                                          .Count() == 0;
                StatusMessage = "El emparejamiento es exitoso";
                if (pairingResult == PairingResult.Partial)
                    StatusMessage = "Código de emparejamiento iniciado por el servidor: " + pairingCode;
            ...
            {
                StatusMessage = $"Emparejamiento fallido ({pairingResult})";
                return RedirectToAction(nameof(ListTokens), new
                {
                    storeId = store.Id
                });
