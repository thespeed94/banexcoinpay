#pragma checksum "C:\Users\Rolando\Desktop\BTCPAY\btcpayserver-master\btcpayserver-master\BTCPayServer\Views\AppsPublic\Crowdfund\VueCrowdfund.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "87a481d75ff97a611eec3a37853dd5433be2fa33"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"87a481d75ff97a611eec3a37853dd5433be2fa33", @"/Views/AppsPublic/Crowdfund/VueCrowdfund.cshtml")]
    ...
    public class Views_AppsPublic_Crowdfund_VueCrowdfund : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            EndContext();
#line 2 "C:\Users\Rolando\Desktop\BTCPAY\btcpayserver-master\btcpayserver-master\BTCPayServer\Views\AppsPublic\Crowdfund\VueCrowdfund.cshtml"
     if(!Model.Enabled) 
    {
...
#line hidden
            ...
            EndContext();
#line 7 "C:\Users\Rolando\Desktop\BTCPAY\btcpayserver-master\btcpayserver-master\BTCPayServer\Views\AppsPublic\Crowdfund\VueCrowdfund.cshtml"
    }

#line default
#line hidden
            BeginContext(236, 16626, true);
        ...
        <div class=""card w-100 p-0 mx-0"">
            ...
            WriteLiteral(@"  ¡Actualmente activo!
                ...
                <span v-if=""srvModel.targetAmount"" class=""mt-3"" id=""crowdfund-header-target"">
                    ...
                    <span v-else 
                          id=""crowdfund-header-target-hardcap"">Softcap Goal <span class=""");
            WriteLiteral(@"fa fa-question-circle"" v-b-tooltip title=""Contributions allowed even after goal is reached""></span> </span>
                </span>
            ...
            <div class=""progress w-100 rounded-0 "" v-if=""srvModel.targetAmount"" 
                ...
                <div class=""progress-bar bg-warning"" role=""progressbar""
                     ...
                     v-bind:st");
            WriteLiteral(@"yle=""{ width: srvModel.info.pendingProgressPercentage + '%' }""
            ...
            <div class=""card-body"">
                <div class=""row py-2 text-center crowdfund-stats"">
                    ...
                    <div  class=""col-sm  border-right"" id=""crowdfund-body-total-contribut");
            WriteLiteral(@"ors"">
                        <h5>
            ...
            WriteLiteral(@"v>
                ...
                <b-tooltip target=""crowdfund-body-raised-amount"" v-if=""paymentStats && ");
            WriteLiteral(@"paymentStats.length > 0"">
                ...
                <div class=""card-title"" id=""crowdfund-body-header"">
                    ...
                    <div class=""row"">
                        <div class=""col-sm-12 col-md-8 col-lg-9"" id=""crowdfund-body-header-tagline-container"">
                            <h2 class=""text-muted"" v-if=""srvModel.tagline"" id=""crowdfund-body-header-tagli");
            WriteLiteral(@"ne"">{{srvModel.tagline}}</h2>
                        </div>
                    ...
                    <b-tabs>
                        <b-tab title=""Details""active>
                            <div class=""row mt-2"">
                                ...
                                <div class=""col-md-4 col-sm-12"" id=""crowdfund-body-contribution-con");
            WriteLiteral(@"tainer"">
            ...
            WriteLiteral(@"=""crowdfund-body-description-container"">
                            <div class=""card-text overflow-hidden"" v-html=""srvModel.description"" id=""crowdfund-body-description""></div>
                        </div>
            ...
            <div class=""card-footer text-muted d-flex"" v-if=""srvModel.animationsEnabled || srvModel.soundsEnabled"">
                ...
                <div class");
            WriteLiteral(@"=""align-self-end pr-4"">Actualizado {{lastUpdated}}</div>
    ...
    <b-modal title=""Contribute"" v-model=""contributeModalOpen"" size=""lg"" ok-only=""true"" ok-variant=""secondary"" ok-title=""Close"" ref=""modalContribute"">
        <contribute v-if=""contributeModalOpen""
                    :target-currency=");
            WriteLiteral(@"""srvModel.targetCurrency""
                    :active=""active""
...
<div class=""card mb-4 perk""  v-bind:class=""{ 'expanded': expanded, 'unexpanded': !expande");
            WriteLiteral(@"d }"" v-on:click=""expand"" :id=""perk.id"">
