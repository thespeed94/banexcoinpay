#pragma checksum "C:\Users\Rolando\Desktop\BTCPAY\btcpayserver-master\btcpayserver-master\BTCPayServer\Views\AppsPublic\Crowdfund\VueCrowdfund.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1735acf23e74613c2e1a018eece32d8a7447b034"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1735acf23e74613c2e1a018eece32d8a7447b034", @"/Views/AppsPublic/Crowdfund/VueCrowdfund.cshtml")]
...
#line hidden
        ...
        <div class=""card w-100 p-0 mx-0"">
            ...
            WriteLiteral(@"rrently Active!
                ...
                <span v-if=""srvModel.targetAmount"" class=""mt-3"" id=""crowdfund-header-target"">
                    ...
                    <span v-else 
                          id=""crowdfund-header-target-hardcap"">Softcap Goal <span class=""fa fa-q");
            WriteLiteral(@"uestion-circle"" v-b-tooltip title=""Contributions allowed even after goal is reached""></span> </span>
                </span>
            ...
            <div class=""progress w-100 rounded-0 "" v-if=""srvModel.targetAmount"" 
                ...
                <div class=""progress-bar bg-warning"" role=""progressbar""
                     ...
                     v-bind:style=""{ ");
            WriteLiteral(@"width: srvModel.info.pendingProgressPercentage + '%' }""
     ...
     ");
            ...
            WriteLiteral(@"            </li>
                    ...
                    <div ");
            WriteLiteral(@" class=""col-sm border-right"" v-if=""ended"" id=""crowdfund-body-campaign-dates-not-active"">
                        <h5>
                            Campaign
                        </h5>
                        <h5 >not active</h5>
...
");
            WriteLiteral(@"                    <ul class=""p-0 text-uppercase"">
       ...
       ");
                ...
                <template v-if=""srvModel.disqusEnabled"">
                    <b-tabs>
                        <b-tab title=""Details""active>
                            ...
                            ");
            WriteLiteral(@"        <contribute :target-currency=""srvModel.targetCurrency""
                ...
                <template v-else>
                    <hr/>
                    <div class=""row mt-2"">
                        <div class=""col-md-8 col-sm-12"" id=""crowdfund-body-description-containe");
            WriteLiteral(@"r"">
                            <div class=""card-text overflow-hidden"" v-html=""srvModel.description"" id=""crowdfund-body-description""></div>
                        </div>
                        <div class=""col-md-4 col-sm-12"" id=""crowdfund-body-contribution-container"">
            ...
            <div class=""card-footer text-muted d-flex"" v-if=""srvModel.animationsEnabled || srvModel.soundsEnabled"">
                ...
                <div class=""align-self-end pr-4"">Updated {{last");
            WriteLiteral(@"Updated}}</div>
...
<sp");
            WriteLiteral(@"an v-if=""displayPerksRanking && perk.sold"" 
            ...
            <div class=""card-title d-flex justify-content-between"" >
                ...
                <span class=""text-muted"" > 
                    <template v-if=""perk.price.value"">{{perk.price.value.noExponents()}} 
                        {{targetCurrency}} 
  ");
            WriteLiteral(@"                      <template v-if=""perk.custom"">or more</template>
                    </template>
            ...
            <div class=""input-group"" style=""max-width: 500px;"" v-if=""expanded"" :id=""'perk-form'+ perk.id"">
                ...
                <div class=""input-group-append"">                    
                    <span class='i");
            WriteLiteral(@"nput-group-text'>{{targetCurrency}}</span>
                    <button 
